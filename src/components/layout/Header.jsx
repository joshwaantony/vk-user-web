    ...
    <>
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex gap-8 text-sm font-semibold">
            ...
            <Link href="/tax-planning" className={navLink("/tax-planning")}>
              Tax Planning
            </Link>
      ...
      >
        ...
        <nav className="flex flex-col gap-5 px-6 py-6 text-sm font-semibold">
          ...
          <Link href="/tax-planning" onClick={() => setOpen(false)} className={navLink("/tax-planning")}>
            Tax Planning
          </Link>
          <Link href="/features" onClick={() => setOpen(false)} className={navLink("/features")}>
            Features
          </Link>
