...
//         {/* What you learn */}
//         <div className="grid grid-cols-1 sm:grid-cols-2 text-[#3D3B3B] gap-2 text-sm mb-4">
//           <span>✔ Corporate tax filing</span>
//           <span>✔ Quarterly tax payments</span>
...
//             <button className="bg-[#1E40E6] text-white px-5 py-2 rounded-lg font-medium hover:bg-[#1a36c9] transition">
//               Enroll Now
//             </button>
//           </div>
//         </div>
