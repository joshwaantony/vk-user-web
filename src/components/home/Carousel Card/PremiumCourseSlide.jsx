...
//   /* ---------------- BACKGROUND PRESETS ---------------- */
//   const backgrounds = [
//     ["#7C3AED", "#8B5CF6", "#9333EA"], // purple
//     ["#0EA5E9", "#38BDF8", "#0284C7"], // blue
...
//             {/* Instructor */}
//             <div className="flex items-center gap-4 bg-white/15 rounded-2xl px-4 py-3 sm:px-5 sm:py-4 mb-7 max-w-lg mx-auto lg:mx-0">
