...
export default function PremiumCourseSlide() {
  ...
  const backgrounds = [
    ["#F3E8FF", "#E9D5FF", "#DDD6FE"], // light purple
    ["#E0F2FE", "#BAE6FD", "#BFDBFE"], // light blue
    ["#DCFCE7", "#BBF7D0", "#86EFAC"], // light green
    ["#FFEDD5", "#FED7AA", "#FDBA74"], // light orange
  ];
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="text-gray-900 text-center lg:text-left relative">
            ...
            <div className="hidden md:flex absolute -top-4 right-0 gap-3">
              <button
                onClick={prevPromo}
                className="w-10 h-10 flex items-center justify-center bg-white border border-[#E5E7EB] text-gray-800 rounded-full hover:scale-110 transition"
              >
                <HiChevronLeft />
              </button>
            ...
            <div className="flex md:hidden justify-center gap-6 mt-8">
              <button
                onClick={prevPromo}
                className="w-10 h-10 flex items-center justify-center bg-white border border-[#E5E7EB] text-gray-800 rounded-full"
              >
                <HiChevronLeft />
              </button>
