...
// import { FiPlay, FiClock, FiChevronDown } from "react-icons/fi";
...
//             <div className="w-7 h-7 rounded-full border border-blue-600 flex items-center justify-center shrink-0">
